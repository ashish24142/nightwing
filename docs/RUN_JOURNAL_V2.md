...
- **Training:** LoRA r16 (α32) on all attention+MLP projections + the randomly-init
...
| A100 pod (~21 h × $1.52: 3 trainings 4.5 h, 8 dev evals ~9 h, test eval 3.5 h, setup/idle rest) | ~$31.60 |
| **v2 total** | **~$32** |
